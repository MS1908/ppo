...
#ppo
    ...
    unscaled_rewards_time_list_ppo  = []
    unscaled_avg_rewards_time_list_ppo = []
    unscaled_rewards_energy_list_ppo = []
    unscaled_avg_rewards_energy_list_ppo = []
    ppo_data = []
...
#ppo   
    ...
    for i in range(t_range):
        ...
        t, bak, bat, unscaled_t, unscaled_bak, unscaled_bat = env.render()
        ...
        unscaled_rewards_time_list_ppo.append(unscaled_t)
        unscaled_avg_rewards_time_list_ppo.append(np.mean(unscaled_rewards_time_list_ppo[:]))
        unscaled_rewards_energy_list_ppo.append(unscaled_bak+unscaled_bat)
        unscaled_avg_rewards_energy_list_ppo.append(np.mean(unscaled_rewards_energy_list_ppo[:]))
        ppo_data.append([avg_rewards_time_list_ppo[-1], avg_rewards_bak_list_ppo[-1], avg_rewards_bat_list_ppo[-1]])
        if dones: env.reset()
        # env.render()
    total_cost.append(avg_rewards_ppo[-1])
    time_cost.append(avg_rewards_time_list_ppo[-1])
    energy_cost.append(avg_rewards_bak_list_ppo[-1] + avg_rewards_bat_list_ppo[-1])
    unscaled_time_cost.append(unscaled_avg_rewards_time_list_ppo[-1])
    unscaled_energy_cost.append(unscaled_avg_rewards_energy_list_ppo[-1])
...
print('--RESULTS--')
print('{:5}{:30}{:10}{:10}{:10}{:10}'.format('p','total cost','time','energy','U-time','U-energy'))
print('{:5}{:<30}{:<10.5}{:<10.5}{:<10.5}{:<10.5}'.format('0', total_cost[0], time_cost[0], energy_cost[0], unscaled_time_cost[0], unscaled_energy_cost[0]))
print('{:5}{:<30}{:<10.5}{:<10.5}{:<10.5}{:<10.5}'.format('0.25', total_cost[1], time_cost[1], energy_cost[1], unscaled_time_cost[1], unscaled_energy_cost[1]))
print('{:5}{:<30}{:<10.5}{:<10.5}{:<10.5}{:<10.5}'.format('0.5', total_cost[2], time_cost[2], energy_cost[2], unscaled_time_cost[2], unscaled_energy_cost[2]))
...
ax1.plot(x_range, unscaled_time_cost, color=color, label='Delay time Cost')
plt.legend() 
...
ax2.plot(x_range, unscaled_energy_cost, color=color, label = 'Energy Cost')
plt.legend()
