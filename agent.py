...
for i in range(t_range):
    ...
    fixed_1_data.append([rewards_time_list_fixed_1[-1], avg_rewards_bak_list_fixed_1[-1], rewards_bat_list_fixed_1[-1]])
    if dones: env.reset()
...
for i in range(t_range):
    ...
    fixed_2_data.append([rewards_time_list_fixed_2[-1], avg_rewards_bak_list_fixed_2[-1], rewards_bat_list_fixed_2[-1]])
    if dones: env.reset()
...
for i in range(t_range):
    ...
    random_data.append([rewards_time_list_random[-1], avg_rewards_bak_list_random[-1], rewards_bat_list_random[-1]])
    if dones: env.reset()
...
for i in range(t_range):
    ...
    ppo_data.append([rewards_time_list_ppo[-1], avg_rewards_bak_list_ppo[-1], rewards_bat_list_ppo[-1]])
    if dones: env.reset()
    # env.render()
# print('--RESULTS--')
